 ...
 * Date: Oct 11, 2010
 */
public class GradleRunnerWrapperTestForToolingApi extends GradleRunnerServiceMessageTestForToolingApi {
  @Override
  @BeforeMethod
  ...
  public void simpleWrapperTest(final String gradleVersion) throws Exception {
    ...
    GradleRunConfiguration config = new GradleRunConfiguration(WRAPPED_PROJECT_A_NAME, "clean", "toolingApi/wrappedProjASequence_clean_tooling_api.txt");
    config.setPatternStr("> Task :clean[^\\r\\n]*|1 actionable task: 1 up-to-date");
  ...
  public void should_Launch_Build_Via_Command_Line_When_GradleWrapperPropertiesIsLocatedInNonStandardDirectory(final String gradleVersion) throws Exception {
    ...
    File initScript = new File(GradleTestUtil.setAgentProjectRoot(new File(".")), GradleTestUtil.REL_SCRIPT_DIR + "/" + GradleRunnerConstants.INIT_SCRIPT_NAME);
