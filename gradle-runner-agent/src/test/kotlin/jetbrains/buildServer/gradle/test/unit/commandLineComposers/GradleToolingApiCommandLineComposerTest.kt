...
import jetbrains.buildServer.gradle.agent.propertySplit.ToolingApiInitScriptConstants
...
class GradleToolingApiCommandLineComposerTest {
    ...
    fun `should populate system properties with explicit values when doNotPopulateGradleProperties flag is set`() {
        ...
        val systemProperties = mutableMapOf(
            ToolingApiInitScriptConstants.TEAMCITY_BUILD_GRADLE_TEST_JVM_ARGS_KEY to "-Xmx512m",
            ToolingApiInitScriptConstants.TEAMCITY_BUILD_STACKTRACE_LOG_DIR_KEY to "/tmp/stacktrace",
            ToolingApiInitScriptConstants.TEAMCITY_BUILD_CHANGED_FILES_KEY to "/tmp/changedFiles.txt",
            ToolingApiInitScriptConstants.TEAMCITY_BUILD_TEMP_DIR_KEY to "/tmp/buildTemp"
        )
        val configParameters = mutableMapOf(
            ...
            ToolingApiInitScriptConstants.TEAMCITY_CONFIGURATION_USE_TEST_RETRY_PLUGIN_KEY to "false",
            ToolingApiInitScriptConstants.TEAMCITY_CONFIGURATION_TEST_NAME_FORMAT_KEY to "customFormat",
            ToolingApiInitScriptConstants.TEAMCITY_CONFIGURATION_IGNORE_SUITE_FORMAT_KEY to "customIgnore"
        )
        ...
        BDDAssertions.then(cmdLine.arguments).contains(
            ...
            "-D${ToolingApiInitScriptConstants.TEAMCITY_BUILD_GRADLE_TEST_JVM_ARGS_KEY}=-Xmx512m",
            "-D${ToolingApiInitScriptConstants.TEAMCITY_BUILD_STACKTRACE_LOG_DIR_KEY}=/tmp/stacktrace",
            "-D${ToolingApiInitScriptConstants.TEAMCITY_BUILD_CHANGED_FILES_KEY}=/tmp/changedFiles.txt",
            "-D${ToolingApiInitScriptConstants.TEAMCITY_BUILD_TEMP_DIR_KEY}=/tmp/buildTemp",
            "-D${ToolingApiInitScriptConstants.TEAMCITY_CONFIGURATION_USE_TEST_RETRY_PLUGIN_KEY}=false",
            "-D${ToolingApiInitScriptConstants.TEAMCITY_CONFIGURATION_TEST_NAME_FORMAT_KEY}=customFormat",
            "-D${ToolingApiInitScriptConstants.TEAMCITY_CONFIGURATION_IGNORE_SUITE_FORMAT_KEY}=customIgnore"
        )
    }
    ...
    fun `should populate system properties with default values when doNotPopulateGradleProperties flag is set and no explicit values are configured`() {
        ...
        BDDAssertions.then(cmdLine.arguments).contains(
            "-D${GradleRunnerConstants.GRADLE_RUNNER_DO_NOT_POPULATE_GRADLE_PROPERTIES_CONFIG_PARAM}=true",
            "-D${ToolingApiInitScriptConstants.TEAMCITY_BUILD_GRADLE_TEST_JVM_ARGS_KEY}=",
            "-D${ToolingApiInitScriptConstants.TEAMCITY_BUILD_STACKTRACE_LOG_DIR_KEY}=",
            "-D${ToolingApiInitScriptConstants.TEAMCITY_BUILD_CHANGED_FILES_KEY}=",
            "-D${ToolingApiInitScriptConstants.TEAMCITY_BUILD_TEMP_DIR_KEY}=",
            "-D${ToolingApiInitScriptConstants.TEAMCITY_CONFIGURATION_USE_TEST_RETRY_PLUGIN_KEY}=true",
            "-D${ToolingApiInitScriptConstants.TEAMCITY_CONFIGURATION_TEST_NAME_FORMAT_KEY}=",
            "-D${ToolingApiInitScriptConstants.TEAMCITY_CONFIGURATION_IGNORE_SUITE_FORMAT_KEY}="
        )
    }
