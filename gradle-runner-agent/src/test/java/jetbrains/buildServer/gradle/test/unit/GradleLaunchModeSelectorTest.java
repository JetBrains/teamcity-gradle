...
public class GradleLaunchModeSelectorTest {
  ...
  @Test
  public void shouldReturnGradleLaunchModeWhenCorrespondingConfigurationParameterIsAbsent() throws RunBuildException {
    // given
  ...
  @Test
  public void shouldReturnGradleLaunchModeWhenCorrespondingConfigurationParameterSet() throws RunBuildException {
    // given
  ...
  @Test
  public void shouldReturnToolingAPiLaunchModeWhenCorrespondingConfigurationParameterSet() throws RunBuildException {
    // given
    Map<String, String> configurationParameters = new HashMap<>();
