...
<tr>
  <td colspan="2" height="5">
    ...
    <div class="attentionComment">
      ...
      Currently, Gradle caching is only performed on ephemeral agents (agents terminated after their first build). Builds running on non-ephemeral agents neither cache nor reuse previously cached dependencies.
    </div>
  </td>
</tr>