...
public class GradleRunnerDiscoveryExtensionTest extends BaseTestCase {
  ...
  protected void setUp() throws Exception {
    ...
    myRoot = new File("../gradle-runner-agent-test/src/test/resources/testProjects", GradleRunnerConstants.INIT_SCRIPT_SINCE_8_NAME);
    if (!myRoot.exists()) {
      myRoot = new File("external-repos/gradle-runner/gradle-runner-agent-test/src/test/resources/testProjects", GradleRunnerConstants.INIT_SCRIPT_SINCE_8_NAME);
    }
